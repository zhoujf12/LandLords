...
void GameControl::playerInit()
{
    ...
    //头像方位设定
    m_robotLeft->setDireaction(Player::Left);
    m_robotRight->setDireaction(Player::Right);
    m_user->setDireaction(Player::Right);

    //性别
    Player::Sex sex;
    sex = (Player::Sex)QRandomGenerator::global()->bounded(2);//随机生成两个数
